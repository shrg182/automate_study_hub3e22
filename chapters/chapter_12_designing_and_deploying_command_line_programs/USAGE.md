...
```bash
python chapters/chapter_12_designing_and_deploying_command_line_programs/example_01.py
```

Or change into this directory first:

```bash
cd chapters/chapter_12_designing_and_deploying_command_line_programs
