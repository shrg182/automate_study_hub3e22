...
**Relative path:** `chapters/chapter_24_text_to_speech_and_speech_recognition_engines`
...
```bash
python chapters/chapter_24_text_to_speech_and_speech_recognition_engines/example_01.py
```

Or change into this directory first:

```bash
cd chapters/chapter_24_text_to_speech_and_speech_recognition_engines
