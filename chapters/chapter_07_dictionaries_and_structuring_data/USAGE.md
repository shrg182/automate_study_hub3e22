...
**Relative path:** `chapters/chapter_07_dictionaries_and_structuring_data`
...
```bash
python chapters/chapter_07_dictionaries_and_structuring_data/example_01.py
```

Or change into this directory first:

```bash
cd chapters/chapter_07_dictionaries_and_structuring_data
