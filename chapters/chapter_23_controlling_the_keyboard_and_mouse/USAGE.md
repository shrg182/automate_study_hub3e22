...
**Directory:** `chapter_23_controlling_the_keyboard_and_mouse`
**Relative path:** `chapters/chapter_23_controlling_the_keyboard_and_mouse`
...
```bash
python chapters/chapter_23_controlling_the_keyboard_and_mouse/example_01.py
```

Or change into this directory first:

```bash
cd chapters/chapter_23_controlling_the_keyboard_and_mouse
