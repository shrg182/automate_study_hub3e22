...
> 📖 **Chapter Page:** https://automatetheboringstuff.com/3e/chapter20.html  
> 🔗 **ATBS Chapter Link:** https://automatetheboringstuff.com/3e/chapter20.html

**Directory:** `chapter_20_sending_email_texts_and_push_notifications`
**Relative path:** `chapters/chapter_20_sending_email_texts_and_push_notifications`
...
```bash
python chapters/chapter_20_sending_email_texts_and_push_notifications/example_01.py
```

Or change into this directory first:

```bash
cd chapters/chapter_20_sending_email_texts_and_push_notifications
