...
```bash
python chapters/chapter_19_keeping_time_scheduling_tasks_and_launching_programs/example_01.py
```

Or change into this directory first:

```bash
cd chapters/chapter_19_keeping_time_scheduling_tasks_and_launching_programs
