...
```bash
python chapters/chapter_09_text_pattern_matching_with_regular_expressions/example_01.py
```

Or change into this directory first:

```bash
cd chapters/chapter_09_text_pattern_matching_with_regular_expressions
