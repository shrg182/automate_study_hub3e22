...
**Relative path:** `chapters/chapter_08_strings_and_text_editing`
...
```bash
python chapters/chapter_08_strings_and_text_editing/example_01.py
```

Or change into this directory first:

```bash
cd chapters/chapter_08_strings_and_text_editing
