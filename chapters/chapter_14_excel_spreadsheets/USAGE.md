...
**Relative path:** `chapters/chapter_14_excel_spreadsheets`
...
```bash
python chapters/chapter_14_excel_spreadsheets/example_01.py
```

Or change into this directory first:

```bash
cd chapters/chapter_14_excel_spreadsheets
