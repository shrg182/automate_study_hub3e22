...
Utility helper functions for chapter_15_google_sheets.
...
def chapter_info() -> dict[str, str]:
    ...
    return {
        "chapter_number": "15",
        "chapter_title": "Chapter 15 - Google Sheets",
        "clean_chapter_title": "Google Sheets",
        "chapter_url": "https://automatetheboringstuff.com/3e/chapter15.html",
        "chapter_dir_name": "chapter_15_google_sheets",
    }
