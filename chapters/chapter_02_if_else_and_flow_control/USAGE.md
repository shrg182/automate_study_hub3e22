...
**Directory:** `chapter_02_if_else_and_flow_control`
**Relative path:** `chapters/chapter_02_if_else_and_flow_control`
...
```bash
python chapters/chapter_02_if_else_and_flow_control/example_01.py
```

Or change into this directory first:

```bash
cd chapters/chapter_02_if_else_and_flow_control
