...
Utility helper functions for chapter_00_introduction.
...
def chapter_info() -> dict[str, str]:
    ...
    return {
        ...
        "clean_chapter_title": "Introduction",
        "chapter_url": "https://automatetheboringstuff.com/3e/chapter0.html",
        "chapter_dir_name": "chapter_00_introduction",
    }
